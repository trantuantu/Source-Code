...
addpath('D:\Code\LabelMeToolbox-master\main')
addpath('D:\Code\LabelMeToolbox-master\primalSVM')
addpath('D:\Code\LabelMeToolbox-master\objectdetection')
addpath('D:\Code\LabelMeToolbox-master\querytools')
addpath('D:\Code\LabelMeToolbox-master\imagemanipulation')
addpath('D:\Code\LabelMeToolbox-master\features')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Parameters
HOMEIMAGES_TRAIN = 'C:\Users\Administrator\Desktop\Temp\data\train'; % each category has to be in a separate folder
HOMEIMAGES_TEST = 'C:\Users\Administrator\Desktop\Temp\data\test'; % each category has to be in a separate folder
