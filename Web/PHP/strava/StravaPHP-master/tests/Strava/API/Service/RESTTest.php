...
class RESTTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateActivity() {
        ...
        $service = new Strava\API\Service\REST('TOKEN',  $pestMock);
        $output = $service->createActivity('test','test','20161120',100);
        $this->assertArrayHasKey('response', $output);
    }
    ...
    public function testUploadActivity() {
        ...
        $pestMock->expects($this->once())->method('post')
           ...
           ->will($this->returnValue('{"response": 1}'));
        $service = new Strava\API\Service\REST('aeb38633d1d63dda20af86c1f1bfe967b61fbf1f',  $pestMock);
        $output = $service->uploadActivity('file.tcx','ride',null,null,null, null, null,'tcx',null);
        $this->assertArrayHasKey('response', $output);
    }
